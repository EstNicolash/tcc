...
\end{figure}
	...
	A compilação é realizada por meio do encadeamento ordenado de operadores \textit{if-then-else} ($ITE$), processados recursivamente a partir da última cláusula (fundo do anidamento):
	\begin{equation}
